...
<div class="row mb-3 area-no-imprimir">
    <div class="col-md-5 ms-auto">
        <div class="input-group shadow-sm">
            ...
            <input type="text" id="buscadorGeneral" class="form-control border-start-0" placeholder="Buscar por código, materia o trayecto...">
        </div>
    </div>
</div>
        ...
        <table class="table table-hover table-striped mb-0 align-middle text-center">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <div class="btn-group">
                            <a href="editar.php?id=<?php echo $m['id']; ?>" class="btn btn-sm btn-outline-primary"><i class="bi bi-pencil"></i></a>
                            <a href="eliminar.php?id=<?php echo $m['id']; ?>" class="btn btn-sm btn-outline-danger" onclick="return confirm('¿Borrar materia?');"><i class="bi bi-trash"></i></a>
                        </div>
                    </td>
                    <?php endif; ?>
                </tr>
